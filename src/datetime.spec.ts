    ...
    describe("Days", () => {
        describe("Addition", () => {
            it("February 28 2018 + 1 day == March 1 2018", () => {
                const mar_01_2018DT = feb_28_2018DT.addDays(1)
                expect(mar_01_2018DT.equals(mar_01_2018D)).toBeTruthy()
            });
        ...
        describe("Subtracting", () => {
            ...
            it("February 28 2018 - 365 days - 366 days (2016 Leap) == February 28 2016", () => {
                expect(feb_28_2018DT.addDays(-365).addDays(-366).equals(feb_28_2016DT)).toBeTruthy()
            });
        });
    });
});
...
describe("Days Between", () => {
    it("February 29 2018 - February 28 2018 = 1 day", () => {
        ...
        expect(date.subtract(toDate).duration().totalDays == 2).toBeTruthy();
    });
    it("February 28 2018 - February 29 2018 = 1 day", () => {
        expect(feb_28_2016DT.subtract(new DateTime(feb_29_2016D)).duration().totalDays == 1).toBeTruthy();
    });
    it("February 28 2016 - February 29 2018 = 731 day", () => {
        expect(feb_28_2016DT.subtract(feb_28_2018DT).duration().totalDays == 731).toBeTruthy();
    });
});